...
from model.rpn_fpn.bbox_transform import clip_boxes
from model.roi_layers import nms
#from model.nms.nms_wrapper import nms
from model.rpn_fpn.bbox_transform import bbox_transform_inv
...
def parse_args():
  ...
  parser.add_argument('--dataset_test', dest='dataset_test',
                      help='training dataset',
                      default='voc_2007_train_nightclear', type=str)
...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  elif args.dataset == "dc_fpn":
      # args.imdb_name = "voc_2007_train_daytimeclear"
      args.imdb_name = args.dataset_test
      # args.imdbval_name = "voc_2007_train_nightclear"
      args.imdbval_name = args.dataset_test
      args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
